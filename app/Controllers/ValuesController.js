...
function _draw() {
  let cardsTemplate = ''
  appState.players.forEach(v => cardsTemplate += v.CardTemplate)
  setHTML('app', /*html*/`
  <div class="my-3">
    <button class="btn btn-primary text-white elevation-2" onclick="app.valuesController.addPlayer()">Add Value</button>  
